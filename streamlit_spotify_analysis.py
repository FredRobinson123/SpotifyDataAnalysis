...
st.title("Freddie's Spotify App")
st.write("This dashboard pulls data from the Spotify API and allows you to analyse artists by their song attributes. The popularity attribute is set on the x-axis and the other attributes can be changed on the y-axis. I hope you enjoy using this!")
